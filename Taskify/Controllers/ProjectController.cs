...
//            {
//                return Ok(new List<ProjectDTO>()); // מחזירים רשימה ריקה אם אין פרויקטים
//            }
...
//            if (user.Id == project.ManagerId || user.Level.ToString() == "headmanager")
//            {
...
//            // אם ManagerId לא מוגדר או קטן מ־1, השתמש במנהל ברירת מחדל
//            if (projectEntity.ManagerId <= 0)
//            {
//                projectEntity.ManagerId = 1; // מזהה המשתמש שיצרת
//                projectEntity.Manager = null; // EF יעשה את ההקשר
//            }
...
//                return NotFound();
//            }
//            if (existingProject.ManagerId != user.Id && user.Level.ToString() != "headmanager")
//            {
//                return Forbid();
//            }
